    ...
    return (
        <div>
            <div class="mx-auto  flex  items-center justify-center">
                <div
                    class="text-white my-20 w-[96%] h-auto rounded-2xl bg-gradient-to-b from-[#8A3FF2] via-[#50248C] to-[#50248C]  p-[2px]">
                    ...
                    <div className='bgresrcads h-[70vh]'>
                        <div className='p-5 w-[100%] sm:w-[60%] h-full flex flex-col md:justify-center items-start'>
                            ...
                            <h1 className='font-sora font-semibold text-5xl my-4'><span className='text-[25px] text-green-400'> Free
                                for
                                all</span> <br />
                                Early members</h1>
                            <Link to="/getNow"><button className='bg-black px-8 py-4 rounded-xl mt-3'>Get now</button></Link>
                        </div>
                ...
                <div className='flex flex-row m-6'>
                    ...
                    <div className='bg-gradient-to-tr from-green-500 to-violet-900 rounded-r-3xl p-1 '>
                        <div className='bg-[#171717] w-[250px] h-full rounded-r-3xl flex flex-col justify-center  items-start p-4'>
                            ...
                            <p className='text-[18px]'>This is your go-to guide for understanding and applying technical analysis in
                                financial markets.</p>
                        </div>
                    </div>
                </div>
