...
const MortgageBorrowerCalculatorInfo = () => {
  ...
  return (
    <div className="mt-8 bg-[#070707]">
      <h1 className="text-2xl font-bold mb-4 text-[#9B4DCA]">About Mortgage Borrower Calculator</h1>
      ...
      <h2 className="text-xl font-semibold mb-4 text-[#9B4DCA]">Why Use the Mortgage Borrower Calculator?</h2>
