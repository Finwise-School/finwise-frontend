...
const SipCalculatorInfo = () => {
  ...
  return (
    <div className="mt-8 bg-[#070707] ">
      <h1 className="text-2xl font-bold mb-4 text-[#9B4DCA]">About SIP Calculator</h1>
      ...
      <h2 className="text-xl font-semibold mb-4 text-[#9B4DCA]">How to Use the SIP Calculator</h2>
      ...
      <h2 className="text-xl font-semibold mb-4 text-[#9B4DCA]">Benefits of Using the SIP Calculator</h2>
