...
const CreditCard_Info = () => {
  ...
  return (
    <div className="mt-8 bg-[#070707]">
      ...
      <h1 className="text-2xl font-bold mb-4 text-[#9B4DCA]">About Pay Off Calculator</h1>
      ...
      <h2 className="text-xl font-semibold mb-4 text-[#9B4DCA]">How to Use the Pay Off Calculator</h2>
      ...
      <h2 className="text-xl font-semibold mb-4 text-[#9B4DCA]">Benefits of Using the Pay Off Calculator</h2>
      ...
      <h2 className="text-base text-gray-300 mb-8">Our Pay Off Calculator empowers you to make informed, proactive decisions about managing and eliminating credit card debt. Try it out to see how small changes in your payments can lead to big savings!</h2>

      {/* Monthly Repayment Calculator Section */}
      <h1 className="text-2xl font-bold mb-4 text-[#9B4DCA]">About Monthly Repayment Calculator</h1>
      <p className="mb-6 text-base text-gray-300">
      ...
      <h2 className="text-xl font-semibold mb-4 text-[#9B4DCA]">How to Use the Monthly Repayment Calculator</h2>
      <ol className="list-decimal list-inside mb-6 space-y-2 text-base text-gray-300">
      ...
      <h2 className="text-xl font-semibold mb-4 text-[#9B4DCA]">Benefits of Using the Monthly Repayment Calculator</h2>
      <ul className="list-disc list-inside mb-6 space-y-2 text-base text-gray-300">
      ...
      <h2 className="text-base text-gray-300 mb-8">This calculator is perfect for taking charge of your financial future and working towards debt elimination!</h2>
