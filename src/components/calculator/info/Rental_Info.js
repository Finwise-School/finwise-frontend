...
const RentalYieldCalculatorInfo = () => {
  ...
  return (
    <div className="mt-8 bg-[#070707]">
      <h1 className="text-2xl font-bold mb-4 text-[#9B4DCA]">About Rental Yield Calculator</h1>
      ...
      <h2 className="text-xl font-semibold mb-4 text-[#9B4DCA]">How to Use:</h2>
      ...
      <h2 className="text-xl font-semibold mb-4 text-[#9B4DCA]">What is Rental Yield?</h2>
      <p className="mb-6 text-base text-gray-300">
      ...
      <h2 className="text-xl font-semibold mb-4 text-[#9B4DCA]">Benefits of Using the Rental Yield Calculator:</h2>
