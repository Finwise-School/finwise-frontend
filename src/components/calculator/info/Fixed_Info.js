...
const FdCalculatorInfo = () => {
  ...
  return (
    <div className="mt-8 bg-[#070707]">
      <h1 className="text-2xl font-bold mb-4 text-[#9B4DCA]">About Fixed Deposit Calculator</h1>
      ...
      <h2 className="text-xl font-semibold mb-4 text-[#9B4DCA]">How to Use the Fixed Deposit Calculator</h2>
      ...
      <h2 className="text-xl font-semibold mb-4 text-[#9B4DCA]">Benefits of Using the Fixed Deposit Calculator</h2>
