    ...
    <div className='bg-gradient-radial from-[#8a3ff240] via-[#070707] h-[90vh] flex flex-col justify-center '>
      <div className='flex flex-col justify-center items-center'>
        ...
        <div className='flex flex-col  sm:flex-row justify-between items-center px-5 mt-6 w-[100%]'>
            <img src={sup1} className='md:w-[350px] md:mt-0 w-[250px] mt-10 grayscale hover:grayscale-0 duration-300 transition-all'></img>
            <img src={sup2} className='md:w-[350px] md:mt-0 w-[250px] mt-10 grayscale hover:grayscale-0 duration-300 transition-all'></img>
            <img src={sup3} className='md:w-[350px] md:mt-0 w-[250px] mt-10 grayscale hover:grayscale-0 duration-300 transition-all'></img>
        </div>
      </div>
    </div>
  )
